package com.bvear.estore.common.util;
...
public class MD5 {
	...
	public static void main(String args[]) {
	    String str1 = "adklshgla";
	    String str2 = "激荡将大幅";
	    String str3 = "89437524352sdfa";
        String str4 = "89437524352sdfa";
        System.out.println(getMD5Str(str1));
        System.out.println(getMD5Str(str2));
        System.out.println(getMD5Str(str3));
        System.out.println(getMD5Str(str4));
	}
	*/
}
